...
export default function RegStep_0({ navigation }) {
  ...
  useEffect(() => {
    setProgress(15); // Устанавливаем прогресс на 0% при загрузке этого шага
  ...
  const handleContinue = () => {
    ...
    updateUser({
      Settings: {
        nativeLanguage: langObj ? langObj.name : String(selectedLanguage),
      },
    });
    navigation.navigate('RegStep_1'); // следующий шаг в AuthStack
  };
  ...
  return (
    <View style={AuthStyles.container}>
      ...
      <View style={AuthStyles.content}>
        <Text style={AuthStyles.title}>Choose your native language</Text>
